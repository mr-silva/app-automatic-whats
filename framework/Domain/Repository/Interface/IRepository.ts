import { PagedList } from '../../Entity'
import { PagedListFiltersDTO, SearchableFilterDTO } from '../DTO'
...
export interface IRepository<TDomainEntity> {
   ...
   *
   * @returns {Promise<PagedList<TDomainEntity>>}
   */
  getPagedList<TFilter extends PagedListFiltersDTO = PagedListFiltersDTO>(
    filters: TFilter
   ...
   */
  getAll<TFilter extends SearchableFilterDTO = SearchableFilterDTO>(
    filters: TFilter
  ): Promise<Array<TDomainEntity>>
